-- ═══════════════════════════════════════════════════════════════
-- SERVIT v8.9.6 — Booking-Level Match Lock
-- 
-- Adds last_match_triggered_at field with 90-second cooldown guard
-- inside match_fixers to prevent duplicate concurrent calls on the same booking.
-- This provides an additional safety layer beyond the request_matching queue.
-- ═══════════════════════════════════════════════════════════════
...
-- ── 2. Update match_fixers with cooldown guard ─────────────────────
